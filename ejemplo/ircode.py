...
Asignación estática única (SSA)
===============================
...
Pruebas
=======
Los archivos Tests/irtest0-5.g contienen texto de entrada junto con resultados de muestra. Trabaje en cada archivo para completar el proyecto.
'''
